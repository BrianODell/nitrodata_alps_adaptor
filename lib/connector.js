...
function updateInstance(instanceReqs,  models, cb) {
    var id = instanceReqs.where;
    var modelName = instanceReqs.model;
    var instance = instanceReqs.attributes;
    var url = join(models.getModelDef(modelName).url, id);
    instance = replaceKeysWithUrls(instance, modelName, models);
